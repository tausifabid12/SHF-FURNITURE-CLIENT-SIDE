    ...
    <>
      ...
      <div className="drawer drawer-mobile ">
        ...
        <div className="drawer-content relative">
          <label
            htmlFor="my-drawer-2"
            className="btn btn-primary btn-xs text-xl absolute top-0 text-white bg-gray-900 border-none rounded-l-none rounded-r-md drawer-button lg:hidden"
          >
            <FaArrowRight />
          </label>
          <div className="py-7">
        ...
        <div className="drawer-side ">
          ...
          <ul className="menu p-4 w-52 lg:w-72  text-base-content bg-white">
