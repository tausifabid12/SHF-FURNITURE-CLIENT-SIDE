  ...
  return (
    <>
      <div id={`slide${id}`} className="carousel-item relative w-full">
        <section className=" bg-[#f1f1f1] lg:pl-16 pr-5 w-full  dark:dark:dark:bg-gray-800 dark:dark:dark:text-gray-100">
        ...
        <div className="absolute hidden lg:flex justify-between transform -translate-y-1/2 left-2 right-2 top-1/2">
          <a
            ...
            className="btn btn-circle bg-transparent border-2  text-gray-900 "
          >
            ❮
          </a>
          <a
